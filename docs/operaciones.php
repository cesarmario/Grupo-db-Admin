<?PHP
    ...
    include('fn/list_operaciones.php');
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <title>Gestion - Operaciones</title>
                        ...
                        <li class="sidebar-item active has-sub ">
                            ...
                            <ul class="submenu active">
                                ...
                                <li class="submenu-item active">
                                    <a href="operaciones.php"><i class="fa-solid fa-circle-chevron-right"></i>&nbsp;Operaciones</a>
                                </li>
                                <li class="submenu-item">
                                ...
                                <div class="card">                                    
                                    ...
                                    <form action="fn/abm_opciones.php" method="GET">
                                        <div class="form-group">
                                            <label for="basicInput">Nueva Operación</label>
